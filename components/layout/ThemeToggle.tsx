...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex size-11 items-center justify-center border border-[color:var(--ghost-border)] bg-transparent text-muted-foreground transition-[color,background-color,border-color,transform] duration-200 hover:border-primary hover:bg-primary/10 hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 active:scale-[0.98]"
