        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col items-center gap-0.5 rounded-xl border border-border bg-muted/20 px-3 py-3">
              <span className="text-sm font-semibold text-foreground tabular-nums">{fmt(result.totalDebt)}</span>
              <span className="text-xs text-muted-foreground">Total Monthly Debt</span>
            </div>
            <div className="flex flex-col items-center gap-0.5 rounded-xl border border-border bg-muted/20 px-3 py-3">
              <span className="text-sm font-semibold text-foreground tabular-nums">{fmt(result.income - result.totalDebt)}</span>
