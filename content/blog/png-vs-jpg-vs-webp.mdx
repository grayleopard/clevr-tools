...
**HEIC** is commonly used by Apple devices, but some websites and apps do not accept it. If the destination rejects a HEIC photo, [convert a copy to JPG](/convert/heic-to-jpg) and keep the original.
